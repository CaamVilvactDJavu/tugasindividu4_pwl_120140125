...
from tugasindividu4_pwl_120140125 import main
from tugasindividu4_pwl_120140125 import models
from tugasindividu4_pwl_120140125.models.meta import Base
...
def dummy_request(tm, dbsession):
    ...
    request.host = 'example.com'
    request.dbsession = dbsession  # type: ignore
    request.tm = tm                # type: ignore
